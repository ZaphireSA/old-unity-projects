...
public class FreeLookCam : PivotBasedCameraRig {
    ...
    {
        recoilAngle = angle;
        //transform.localEulerAngles = transform.localEulerAngles + Vector3.left * angle;
    }
    ...
    private void HandleZoom()
    {
        ...
        if (player != null)
        {
            ...
            {
                float targetZoom = originalFOV / 2;
                m_camera.fieldOfView = Mathf.Lerp(m_camera.fieldOfView, targetZoom, Time.deltaTime * fovSmoothSpeed);
            } else
            {
    ...
    private void HandleRotationMovement()
    {
        ...
        m_PivotTargetRot.eulerAngles += Vector3.left * recoilAngle;        
